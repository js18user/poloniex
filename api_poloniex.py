...
async def web_api_poloniex_analyze(number, interval):
    ...
    try:
        ...
        async with websockets.connect('wss://api2.poloniex.com') as web_api_poloniex:
            ...
            await web_api_poloniex.send(request)

            confirmation = json.loads(await web_api_poloniex.recv())
            ...
            while 1:
                ...
                ticker = json.loads(await web_api_poloniex.recv())[2]
...
async def asynchronous(intervals):
    ...
    tasks = [asyncio.ensure_future(web_api_poloniex_analyze(number, intervals[number]))
